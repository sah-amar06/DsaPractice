...
public class SmallestLetterGreaterThanTarget {
	...
	public static void main(String[] args) {
		...
		System.out.println(getSmallestLetterGreaterThanTarget(ch, 'e'));
		
		char[] ch1 = {'c','d','f','h'};
		System.out.println(getSmallestLetter(ch1, 'k'));
		System.out.println(getSmallestLetter(ch1, 'g'));
	}
	...
	/**
	 * Get the smallest letter greater than the target letter
	 * if no greater letter found, return '#'
	 * @param letters
	 * @param target
	 */
