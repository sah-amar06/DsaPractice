...
public class FindMinimumInRotatedSortedArray {
	 ...
	 * Observation:
	 *
	 * In a rotated sorted array, the minimum element always
	 * appears immediately after the pivot (largest element).
	 *
	 * Therefore,
	 *
	 * 1. Find the pivot.
	 * 2. If no pivot exists, the array is not rotated and
	 *    the first element is the minimum.
	 * 3. Otherwise, return arr[pivot + 1].
	 */
	...
	public static void getMinimumBS(int[] arr) {
